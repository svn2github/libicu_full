...
**********************************************************************
*
* This test is intended only to be run for the collection of performance
* profiling data not as a measure of performance itself.  The collected
* profile data can be used across multiple releases of ICU to determine
* changes releative to the date/time format and parsing round trip testing.
*
**********************************************************************
*/

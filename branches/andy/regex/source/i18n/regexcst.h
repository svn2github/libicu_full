...
static const struct RegexTableEl gRuleParseStateTable[] = {
    ...
    , {doRuleError, 255, 165,0,  FALSE}     //  13 
    ...
    , {doConditionalExpr, 40 /* ( */, 165,0,  TRUE}     //  41 
    , {doPerlInline, 123 /* { */, 165,0,  TRUE}     //  42 
    , {doBadOpenParenType, 255, 165,0,  FALSE}     //  43 
    , {doOpenLookBehind, 61 /* = */, 2, 20, TRUE}     //  44      open-paren-lookbehind
    , {doOpenLookBehindNeg, 33 /* ! */, 2, 20, TRUE}     //  45 
    , {doBadOpenParenType, 255, 165,0,  FALSE}     //  46 
    , {doNOP, 41 /* ) */, 255,0,  TRUE}     //  47      paren-comment
    , {doMismatchedParenErr, 253, 165,0,  FALSE}     //  48 
    ...
    , {doBadModeFlag, 255, 165,0,  FALSE}     //  58 
    ...
    , {doEscapeError, 253, 165,0,  FALSE}     //  99 
    ...
    , {doRuleError, 255, 165,0,  FALSE}     //  108 
    , {doSetLiteral, 254, 114,0,  TRUE}     //  109      set-start
    , {doSetEnd, 93 /* ] */, 255,0,  TRUE}     //  110 
    , {doSetBeginUnion, 91 /* [ */, 101, 121, TRUE}     //  111 
    , {doNOP, 92 /* \ */, 154,0,  TRUE}     //  112 
    , {doSetLiteral, 255, 114,0,  TRUE}     //  113 
    , {doSetLiteral, 254, 114,0,  TRUE}     //  114      set-after-lit
    , {doSetEnd, 93 /* ] */, 255,0,  TRUE}     //  115 
    , {doSetBeginUnion, 91 /* [ */, 101, 121, TRUE}     //  116 
    , {doNOP, 45 /* - */, 143,0,  TRUE}     //  117 
    , {doNOP, 92 /* \ */, 154,0,  TRUE}     //  118 
    , {doSetNoCloseError, 253, 165,0,  FALSE}     //  119 
    , {doSetLiteral, 255, 114,0,  TRUE}     //  120 
    , {doSetLiteral, 254, 114,0,  TRUE}     //  121      set-after-set
    , {doSetEnd, 93 /* ] */, 255,0,  TRUE}     //  122 
    , {doSetBeginUnion, 91 /* [ */, 101, 121, TRUE}     //  123 
    , {doNOP, 45 /* - */, 136,0,  TRUE}     //  124 
    , {doNOP, 92 /* \ */, 154,0,  TRUE}     //  125 
    , {doNOP, 38 /* & */, 129,0,  TRUE}     //  126 
    , {doSetNoCloseError, 253, 165,0,  FALSE}     //  127 
    , {doSetLiteral, 255, 114,0,  TRUE}     //  128 
    , {doSetAddAmp, 254, 133,0,  FALSE}     //  129      set-amp-S-1
    , {doSetBeginIntersection1, 91 /* [ */, 101, 121, TRUE}     //  130 
    , {doSetIntersection2, 38 /* & */, 149,0,  TRUE}     //  131 
    , {doSetAddAmp, 255, 133,0,  FALSE}     //  132 
    , {doSetLiteral, 254, 114,0,  TRUE}     //  133      set-amp-lit
    , {doSetEnd, 93 /* ] */, 255,0,  TRUE}     //  134 
    , {doSetLiteral, 255, 114,0,  TRUE}     //  135 
    , {doSetAddDash, 254, 140,0,  FALSE}     //  136      set-dash-S-1
    , {doSetBeginDifference1, 91 /* [ */, 101, 121, TRUE}     //  137 
    , {doSetDifference2, 45 /* - */, 149,0,  TRUE}     //  138 
    , {doSetAddDash, 255, 140,0,  FALSE}     //  139 
    , {doSetLiteral, 254, 114,0,  TRUE}     //  140      set-dash-lit
    , {doSetEnd, 93 /* ] */, 255,0,  TRUE}     //  141 
    , {doSetLiteral, 255, 114,0,  TRUE}     //  142 
    , {doSetRange, 254, 114,0,  TRUE}     //  143      set-dash-L-1
    , {doSetDifference2, 45 /* - */, 149,0,  TRUE}     //  144 
    , {doSetAddDash, 91 /* [ */, 114,0,  FALSE}     //  145 
    , {doSetAddDash, 93 /* ] */, 114,0,  FALSE}     //  146 
    , {doSetAddDash, 92 /* \ */, 154,0,  TRUE}     //  147 
    , {doSetRange, 255, 114,0,  TRUE}     //  148 
    , {doSetLiteral, 254, 114,0,  TRUE}     //  149      set-after-op
    , {doSetBeginUnion, 91 /* [ */, 101, 121, TRUE}     //  150 
    , {doSetOpError, 93 /* ] */, 165,0,  FALSE}     //  151 
    , {doNOP, 92 /* \ */, 154,0,  TRUE}     //  152 
    , {doSetLiteral, 255, 114,0,  TRUE}     //  153 
    , {doSetProp, 112 /* p */, 121,0,  FALSE}     //  154      set-escape
    , {doSetProp, 80 /* P */, 121,0,  FALSE}     //  155 
    , {doSetProp, 78 /* N */, 121,0,  FALSE}     //  156 
    , {doSetBackslash_s, 115 /* s */, 121,0,  TRUE}     //  157 
    , {doSetBackslash_S, 83 /* S */, 121,0,  TRUE}     //  158 
    , {doSetBackslash_w, 119 /* w */, 121,0,  TRUE}     //  159 
    , {doSetBackslash_W, 87 /* W */, 121,0,  TRUE}     //  160 
    , {doSetBackslash_d, 100 /* d */, 121,0,  TRUE}     //  161 
    , {doSetBackslash_D, 68 /* D */, 121,0,  TRUE}     //  162 
    , {doSetLiteral, 255, 114,0,  TRUE}     //  163 
    , {doSetFinish, 255, 14,0,  FALSE}     //  164      set-finish
    , {doExit, 255, 165,0,  TRUE}     //  165      errorDeath
 };

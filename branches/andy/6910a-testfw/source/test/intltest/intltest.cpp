    ...
    do {
        ...
        if (run_this_test) {
            ...
            try {
                ...
                // an ASSERT_ test failed, and threw this exception to
                // abort the test early. A normal error message was output
                // for the failure; nothing extra is really needed here.
            }

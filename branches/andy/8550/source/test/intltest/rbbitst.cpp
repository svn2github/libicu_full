...
struct TestParams {
    ...
    std::string      utf8String;           // UTF-8 form of text to break.
...
void TestParams::setUTF8(UErrorCode &status) {
    utf8String.clear();
    dataToBreak.toUTF8String(utf8String);
    textToBreak = utext_openUTF8(textToBreak, utf8String.c_str(), utf8String.length(), &status);

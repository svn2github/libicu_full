        ...
        case URX_ONECHAR_I:
            ...
            if (currentLen == 0) {
                ...
                if (u_hasBinaryProperty(c, UCHAR_CASE_SENSITIVE)) {
                    #if 0
                    // Code for simple case folding.
                    // Needs to be enhanced for case-folding to/from strings.
                    // A tricky case:  pattern starts with s, matching data could start with 
                    //                 a German sharp-s.  
                    //   maybe?  put first two and three chars from string into a set, then case-close.
                    //
                    ...
                    //  Temporary, disable optimization on first character.
                    fRXPat->fInitialChars->clear();
                    fRXPat->fInitialChars->complement();
                    #endif

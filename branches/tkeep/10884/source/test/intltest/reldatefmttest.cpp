...
static WithQuantityExpected kEnglishNarrow[] = {
        ...
        {0.0, UDAT_DIRECTION_NEXT, UDAT_RELATIVE_DAYS, "+0 d"},
        {0.5, UDAT_DIRECTION_NEXT, UDAT_RELATIVE_DAYS, "+0.5 d"},
        {1.0, UDAT_DIRECTION_NEXT, UDAT_RELATIVE_DAYS, "+1 d"},
        {2.0, UDAT_DIRECTION_NEXT, UDAT_RELATIVE_DAYS, "+2 d"},
        {0.0, UDAT_DIRECTION_NEXT, UDAT_RELATIVE_WEEKS, "+0 w"},
        {0.5, UDAT_DIRECTION_NEXT, UDAT_RELATIVE_WEEKS, "+0.5 w"},
        {1.0, UDAT_DIRECTION_NEXT, UDAT_RELATIVE_WEEKS, "+1 w"},
        {2.0, UDAT_DIRECTION_NEXT, UDAT_RELATIVE_WEEKS, "+2 w"},
        {0.0, UDAT_DIRECTION_NEXT, UDAT_RELATIVE_MONTHS, "+0 m"},
        {0.5, UDAT_DIRECTION_NEXT, UDAT_RELATIVE_MONTHS, "+0.5 m"},
        {1.0, UDAT_DIRECTION_NEXT, UDAT_RELATIVE_MONTHS, "+1 m"},
        {2.0, UDAT_DIRECTION_NEXT, UDAT_RELATIVE_MONTHS, "+2 m"},
        {0.0, UDAT_DIRECTION_NEXT, UDAT_RELATIVE_YEARS, "+0 y"},
        {0.5, UDAT_DIRECTION_NEXT, UDAT_RELATIVE_YEARS, "+0.5 y"},
        {1.0, UDAT_DIRECTION_NEXT, UDAT_RELATIVE_YEARS, "+1 y"},
        {2.0, UDAT_DIRECTION_NEXT, UDAT_RELATIVE_YEARS, "+2 y"},
        ...
        {0.5, UDAT_DIRECTION_LAST, UDAT_RELATIVE_HOURS, "-0.5go"},
        {1.0, UDAT_DIRECTION_LAST, UDAT_RELATIVE_HOURS, "-1 h"},
        {2.0, UDAT_DIRECTION_LAST, UDAT_RELATIVE_HOURS, "-2 h"},
        {0.0, UDAT_DIRECTION_LAST, UDAT_RELATIVE_DAYS, "-0 d"},
        {0.5, UDAT_DIRECTION_LAST, UDAT_RELATIVE_DAYS, "-0.5 d"},
        {1.0, UDAT_DIRECTION_LAST, UDAT_RELATIVE_DAYS, "-1 d"},
        {2.0, UDAT_DIRECTION_LAST, UDAT_RELATIVE_DAYS, "-2 d"},
        {0.0, UDAT_DIRECTION_LAST, UDAT_RELATIVE_WEEKS, "-0 w"},
        {0.5, UDAT_DIRECTION_LAST, UDAT_RELATIVE_WEEKS, "-0.5 w"},
        {1.0, UDAT_DIRECTION_LAST, UDAT_RELATIVE_WEEKS, "-1 w"},
        {2.0, UDAT_DIRECTION_LAST, UDAT_RELATIVE_WEEKS, "-2 w"},
        {0.0, UDAT_DIRECTION_LAST, UDAT_RELATIVE_MONTHS, "-0 m"},
        {0.5, UDAT_DIRECTION_LAST, UDAT_RELATIVE_MONTHS, "-0.5 m"},
        {1.0, UDAT_DIRECTION_LAST, UDAT_RELATIVE_MONTHS, "-1 m"},
        {2.0, UDAT_DIRECTION_LAST, UDAT_RELATIVE_MONTHS, "-2 m"},
        {0.0, UDAT_DIRECTION_LAST, UDAT_RELATIVE_YEARS, "-0 y"},
        {0.5, UDAT_DIRECTION_LAST, UDAT_RELATIVE_YEARS, "-0.5 y"},
        {1.0, UDAT_DIRECTION_LAST, UDAT_RELATIVE_YEARS, "-1 y"},
        {2.0, UDAT_DIRECTION_LAST, UDAT_RELATIVE_YEARS, "-2 y"} 
};
...
static WithoutQuantityExpected kEnglishNoQuantityShort[] = {
        ...
        {UDAT_DIRECTION_PLAIN, UDAT_ABSOLUTE_MONDAY, "Mon"},
        {UDAT_DIRECTION_PLAIN, UDAT_ABSOLUTE_TUESDAY, "Tue"},
        {UDAT_DIRECTION_PLAIN, UDAT_ABSOLUTE_WEDNESDAY, "Wed"},
        {UDAT_DIRECTION_PLAIN, UDAT_ABSOLUTE_THURSDAY, "Thu"},
        {UDAT_DIRECTION_PLAIN, UDAT_ABSOLUTE_FRIDAY, "Fri"},
        {UDAT_DIRECTION_PLAIN, UDAT_ABSOLUTE_SATURDAY, "Sat"},
        {UDAT_DIRECTION_PLAIN, UDAT_ABSOLUTE_SUNDAY, "Sun"},
...
static WithoutQuantityExpected kEnglishNoQuantityNarrow[] = {
        ...
        {UDAT_DIRECTION_NEXT, UDAT_ABSOLUTE_MONTH, "next mo."},
        {UDAT_DIRECTION_NEXT, UDAT_ABSOLUTE_YEAR, "next yr."},
        {UDAT_DIRECTION_NEXT, UDAT_ABSOLUTE_MONDAY, "next Mo"},
        {UDAT_DIRECTION_NEXT, UDAT_ABSOLUTE_TUESDAY, "next Tu"},
        {UDAT_DIRECTION_NEXT, UDAT_ABSOLUTE_WEDNESDAY, "next We"},
        {UDAT_DIRECTION_NEXT, UDAT_ABSOLUTE_THURSDAY, "next Th"},
        {UDAT_DIRECTION_NEXT, UDAT_ABSOLUTE_FRIDAY, "next Fr"},
        ...
        {UDAT_DIRECTION_LAST, UDAT_ABSOLUTE_MONTH, "last mo."},
        {UDAT_DIRECTION_LAST, UDAT_ABSOLUTE_YEAR, "last yr."},
        {UDAT_DIRECTION_LAST, UDAT_ABSOLUTE_MONDAY, "last Mo"},
        {UDAT_DIRECTION_LAST, UDAT_ABSOLUTE_TUESDAY, "last Tu"},
        {UDAT_DIRECTION_LAST, UDAT_ABSOLUTE_WEDNESDAY, "last We"},
        {UDAT_DIRECTION_LAST, UDAT_ABSOLUTE_THURSDAY, "last Th"},
        {UDAT_DIRECTION_LAST, UDAT_ABSOLUTE_FRIDAY, "last Fr"},

...
GENRB_SYNTHETIC_ALIAS = en_RH.txt in.txt in_ID.txt iw.txt\
 iw_IL.txt ja_JP_TRADITIONAL.txt no_NO.txt no_NO_NY.txt th_TH_TRADITIONAL.txt


# All aliases (to not be included under 'installed'), but not including root.
GENRB_ALIAS_SOURCE = $(GENRB_SYNTHETIC_ALIAS) az_AZ.txt ha_NG.txt no.txt pa_IN.txt\
...
GENRB_SOURCE = af.txt af_NA.txt af_ZA.txt am.txt\
 ...
 ro_RO.txt ru.txt ru_RU.txt ru_UA.txt si.txt\

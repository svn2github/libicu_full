...
LANG_SOURCE = af.txt am.txt ar.txt ar_AE.txt\
 ...
 as.txt az.txt az_Cyrl.txt az_Latn_AZ.txt be.txt\
 bg.txt bn.txt bn_IN.txt bo.txt ca.txt\
 cs.txt cy.txt da.txt de.txt de_CH.txt\
 el.txt en.txt eo.txt es.txt es_AR.txt\
 es_CL.txt et.txt eu.txt fa.txt fa_AF.txt\
 fi.txt fo.txt fr.txt ga.txt gl.txt\
 ...
 ne.txt nl.txt nl_BE.txt nn.txt om.txt\
 or.txt pa.txt pa_Arab.txt pa_Arab_PK.txt pa_Guru_IN.txt\
 pl.txt ps.txt pt.txt pt_PT.txt ro.txt\
 ru.txt ru_UA.txt si.txt sk.txt sl.txt\
 so.txt sq.txt sr.txt sr_Cyrl_BA.txt sr_Cyrl_RS.txt\
 ...
 uz_Arab.txt uz_Arab_AF.txt uz_Cyrl_UZ.txt uz_Latn.txt vi.txt\
 zh.txt zh_Hans_CN.txt zh_Hans_SG.txt zh_Hant.txt zh_Hant_HK.txt\

...
void RBBITest::runIndexedTest( int32_t index, UBool exec, const char* &name, char* params )
{
    ...
    switch (index) {
        ...
        case 21: name = "TestDictRules";
            if (exec) TestDictRules();                         break;
        case 22: name = "TestBug5532";
...
RBBIWordMonkey::RBBIWordMonkey()
{
    ...
    fOtherSet->removeAll(UnicodeSet(UNICODE_STRING_SIMPLE("[\\p{LineBreak = Complex_Context}\\p{Script = Hangul}]"), status));
    fALetterSet->removeAll(UnicodeSet(UNICODE_STRING_SIMPLE("[\\p{Script = Hangul}]"), status));
...
void RBBITest::TestWordBreaks(void)
{
    ...
    "\\u0027\\u11af\\U000e0057\\u0602",
    "\\U0001d7f2\\U000e007\\u0004\\u0589",
    "\\U000e0022\\u003a\\u10b3\\u003a\\u021b\\u002e\\U000e0058\\u1732\\U000e002b",
    "\\U0001d7f2\\U000e007d\\u0004\\u0589",
    "\\u82ab\\u17e8\\u0736\\u2019\\U0001d64d",
    "\\u055c\\u0a68\\U000e0037\\u0cd6\\u002c\\u0959",
    "\\U000e0065\\u302c\\u0986\\u09ee\\U000e0068",
    "\\u0be8\\u002e\\u0c68\\u066e\\u136d\\ufc99\\u59e7",
    "\\u0233\\U000e0020\\u0a69\\u0d6a",
    "\\u206f\\u0741\\u03ab\\u2019\\u0cac\\u2019",
    "\\u58f4\\U000e0049\\u20e7\\u2027",
    "\\u0315\\U0001d7e5\\U000e0073\\u0c47\\u06f2\\u0c6a\\u0037\\u10fe",
    "\\u0183\\u102d\\u0bec\\u003a",
    "\\u17e8\\u06e7\\u002e\\u096d\\u003b",
    "\\u003a\\u0e57\\u0fad\\u002e",
    "\\u002e\\U000e004c\\U0001d7ea\\u05bb\\u00fd\\u02de",
    "\\u32e6\\U0001d7f6\\u0fa1\\u206a\\U000e003c\\u0cec\\u003a",
    "\\U000e005d\\u2044\\u0731\\u0650\\u0061",
    "\\u003a\\u0664\\u00b7\\u1fba",
    "\\u003b\\u0027\\u00b7\\u47a3",
    "\\u2027\\U000e0067\\u0a42\\u00b7\\u0ddf\\u026c\\u003a\\u4186\\u041b",
    "\\u0027\\u003a\\U0001d70f\\U0001d7df\\u0f4a\\U0001d7f5\\U0001d177\\u003a\\u0e51\\u1058\\U000e0058\\u00b7\\u0673",
    "\\u030d\\u002e\\U000e002c\\u0c48\\u003a\\u05a1\\u0661\\u002c",
    };
    int loop;
    if (U_FAILURE(status)) {

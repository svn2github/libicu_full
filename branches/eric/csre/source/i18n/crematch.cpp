...
//
void CSREMatcher::init2(const UnicodeString &input, UErrorCode &status) {
    if (U_FAILURE(status)) {
        fDeferredStatus = status;
        return;
    }
...
//
//--------------------------------------------------------------------------------
UBool CSREMatcher::isWordBoundary(int32_t pos) {
...
//
//--------------------------------------------------------------------------------
UBool CSREMatcher::isUWordBoundary(int32_t pos) {
...
//
//--------------------------------------------------------------------------------
inline REStackFrame *CSREMatcher::StateSave(REStackFrame *fp, int32_t savePatIdx, UErrorCode &status) {
...
//
//--------------------------------------------------------------------------------
void CSREMatcher::MatchAt(int32_t startIdx, UBool toEnd, UErrorCode &status) {

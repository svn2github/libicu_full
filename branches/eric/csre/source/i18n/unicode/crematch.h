...
/**
 * \file
 * \brief  C++ API:  Collation Sensitive Regular Expressions
 *
 * <h2>Collation Sensitive Regular Expression API</h2>
 *
...
private:
     ...
     * @internal
     */
    CSREMatcher(const UCollator *coll, const UnicodeString &regexp, const UChar *input,
        uint32_t flags, UErrorCode &status);
public:

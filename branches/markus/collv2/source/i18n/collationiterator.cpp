...
int32_t
CollationIterator::appendCEsFromCpNoContext(int32_t cesLength, UChar32 c, UErrorCode &errorCode) {
...
int32_t
CollationIterator::appendCEsFromCE32NoContext(int32_t cesLength,

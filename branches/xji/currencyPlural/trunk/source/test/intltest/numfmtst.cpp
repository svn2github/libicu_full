...
void NumberFormatTest::runIndexedTest( int32_t index, UBool exec, const char* &name, char* /*par*/ )
{
    ...
    switch (index) {
        ...
        CASE(37, TestSpaceParsing);
        CASE(38, TestMultiCurrencySign);
        CASE(39, TestCurrencyFormatForMixParsing);
        CASE(40, TestDecimalFormatCurrencyParse);
        CASE(41, TestCurrencyIsoPluralFormat);

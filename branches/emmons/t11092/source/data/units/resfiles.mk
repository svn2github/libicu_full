...
#    |  UNITS_SOURCE_LOCAL =   myLocale.txt ...
#
#  * To REPLACE the default list and only build with a few
#    locales:
#    _____________________________________________________
#    |  UNITS_SOURCE = ar.txt ar_AE.txt en.txt de.txt zh.txt
#
#
# Generated by LDML2ICUConverter, from LDML source files.

# Aliases without a corresponding xx.xml file (see icu-config.xml & build.xml)
UNITS_SYNTHETIC_ALIAS = az_AZ.txt az_Latn_AZ.txt bs_BA.txt bs_Latn_BA.txt\
...
UNITS_ALIAS_SOURCE = $(UNITS_SYNTHETIC_ALIAS)


# Ordinary resources
UNITS_SOURCE = af.txt agq.txt ak.txt am.txt\

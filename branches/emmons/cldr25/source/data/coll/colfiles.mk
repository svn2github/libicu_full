...
COLLATION_SYNTHETIC_ALIAS = de_.txt de__PHONEBOOK.txt es_.txt es__TRADITIONAL.txt\
 ...
 pa_Guru_IN.txt pa_IN.txt ro_MD.txt sh.txt sh_BA.txt\
 sh_CS.txt sh_YU.txt sr_BA.txt sr_Cyrl_BA.txt sr_Cyrl_ME.txt\
 sr_Cyrl_RS.txt sr_Latn_BA.txt sr_Latn_RS.txt sr_ME.txt sr_RS.txt\
 ug_Arab_CN.txt ug_CN.txt zh_CN.txt zh_HK.txt zh_Hans_CN.txt\
...
COLLATION_SOURCE = $(COLLATION_EMPTY_SOURCE) af.txt ar.txt as.txt\
 ...
 my.txt nb.txt nl.txt nn.txt om.txt\
